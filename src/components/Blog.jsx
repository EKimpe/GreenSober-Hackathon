            ...
            <CardDeck>
              <Card className='mt-5'>
                ...
                <CardBody>
                  ...
                  <CardText>
                    Alors qu’il se vend près de 47 smartphones par seconde dans
                    le monde, cette production n’est pas sans conséquence sur la
                    planète. Devenu un objet dont on peut difficilement se
                    passer, le smartphone voit ses ventes croître de manière
                    fulgurante depuis plus d'une décennie
                  </CardText>
                  <Button onClick={this.handleClick}>En savoir plus</Button>
                </CardBody>
              </Card>
              <Card className='mt-5'>
                <CardImg
          ...
          <Col>
            <CardDeck>
              <Card className='mt-5 mb-5'>
                ...
                <CardBody>
                  ...
                  <CardText>
                    ...
                    % de la consommation mondiale d’électricité. Et ce chiffre
                    ne cesse d’augmenter. S’il n’est évidemment pas question de
                    se passer des progrès apportés par le numérique, les
                    scientifiques pointent un mode de fonctionnement peu
                    optimisé et très énergivore. Cet article fait partie du Top
                    10 des contenus les plus lus sur notre site cette année.
                  </CardText>
                  <Button>En savoir plus</Button>
                </CardBody>
              </Card>
              ...
              <Card className='mt-5 mb-5'>
                ...
                <CardBody>
                  <CardTitle>
                    Fairphone, l’OVNI des smartphones, à l’assaut du grand
                    public
                  </CardTitle>
                  <CardText>
